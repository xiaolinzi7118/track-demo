      ...
      <el-table :data="tableData" border stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="250" fixed="right">
          <template #default="{ row }">
            ...
            <el-button v-permission="'system-user:delete'" link type="danger" @click="handleDelete(row)" :disabled="row.username === 'admin'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
...
const handleAdd = () => {
  ...
  Object.assign(userForm, { id: null, username: '', password: '', nickname: '', roleId: null, status: 1 })
