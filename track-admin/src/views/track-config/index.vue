    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>埋点配置列表</span>
          <el-button type="primary" @click="handleAdd" v-permission="'track-config:add'">
      ...
      >
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" @click="handleEdit(row)" v-permission="'track-config:edit'">编辑</el-button>
            <el-button link type="danger" @click="handleDelete(row)" v-permission="'track-config:delete'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
